...
export default {
  ...
  methods: {
    downloadFile () {
      axios.get('http://dmc.yozocloud.cn/api/file/download?appId=yozoYyrdp1Br0048&fileVersionId=732169009956392961_0&sign=F8D4C25D33EBC509911BF34D7C8345BAF37B63A4823179811194F0FA93FC5A6F', {
        responseType: 'blob'
      }).then(res => {
        console.log(res)
        const url = URL.createObjectURL(res.data)
        console.log(url)
        window.open(` http://vw.usdoc.cn/?w=5&src=${url}`)
      })
    },
    setControlKey (event) {
